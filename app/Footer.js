...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://facebook.com/gramshreemart",
      name: "Facebook",
    },
    {
      icon: Instagram,
      href: "https://instagram.com/gramshreemart",
      name: "Instagram",
    },
    {
      icon: Twitter,
      href: "https://twitter.com/gramshreemart",
      name: "Twitter",
    },
    {
      icon: Linkedin,
      href: "https://linkedin.com/company/gramshreemart",
      name: "LinkedIn",
    },
    {
      icon: Youtube,
      href: "https://youtube.com/gramshreemart",
      name: "YouTube",
    },
  ];
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed max-w-md">
                  Built on value, trust, and day-to-day demand, Gram Shree is
          ...
          <div className="bg-gray-800/50 rounded-2xl p-6 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-gray-300 leading-relaxed">
              <div>
                ...
                <p>
                  Gram Shree Mart is a registered MSME enterprise under the
              ...
              <div>
                ...
                <p>
                  ...
                  respective authorities. Gram Shree Mart provides facilitation
            ...
            <div className="mt-4 pt-4 border-t border-gray-700">
              <p className="text-xs text-gray-400">
                ...
                official government sources. Gram Shree Mart facilitates
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              ...
              <p className="mt-1">
                A venture committed to empowering entrepreneurs across India
                with government support and proven business models.
              </p>
            </div>

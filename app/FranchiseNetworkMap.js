...
const FranchiseNetworkContent = memo(() => {
  return (
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              aria-label="Apply for franchise opportunity"
            >
              Apply for Franchise
            </button>
            <button 
              ...
              aria-label="View all franchise locations"
            >
              View All Locations
            </button>
          </div>
...
FranchiseNetworkContent.displayName = 'FranchiseNetworkContent';
